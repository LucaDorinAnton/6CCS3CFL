...
val v1 = lex(r1, s1.toList) // Returns Stars(List(Chr(a), Chr(a), Chr(a)))


val r2 = ALT("a", ONE)^3
val s2 = "aa"

val v2 = lex(r2, s2.toList) // Stars(List(Left(Chr(a)), Left(Chr(a)), Right(Empty)))
...
val a1 = lex(WHILE_REGS, p1.toList)
val env1 = lexer(WHILE_REGS, p1) // returns List((k,read), (w," "), (id,n), (s,;))
...
val lexed_fib = escape(sanitize(lexing_simp(WHILE_REGS, fib)))
/*
List(
(k,"write"),
(str,"\"Fib\""),
...
val lexed_loops = escape(sanitize(lexing_simp(WHILE_REGS, loops)))
/*
List(
(id,"start"),
(op,":="),
...
val factors = """// Find all factors of a given input number
...
val lexed_factors = escape(sanitize(lexing_simp(WHILE_REGS, factors)))
/*
List(
(k,"write"),
(str,"\"Input n please\""),
